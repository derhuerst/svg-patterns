...
"use strict";var stringify=require("virtual-dom-stringify"),patterns=require("./index.js"),type=document.querySelector("#demo-type"),opt=document.querySelector("#demo-options"),defs=document.querySelector("#demo-target defs"),defaults={id:"demo-pattern",size:20},render=function(){var e=type.value.split(","),t=Object.assign({},defaults,JSON.parse(opt.value)),r=1===e.length?patterns[e[0]](t):patterns[e[0]](e[1],t);defs.innerHTML=stringify(r)};type.addEventListener("change",render),opt.addEventListener("change",render),opt.addEventListener("keypress",function(){return setTimeout(render,5)}),setTimeout(render,0);

},{"./index.js":3,"virtual-dom-stringify":26}],2:[function(require,module,exports){
"use strict";var shortid=require("shortid").generate,dom=require("virtual-dom/h"),round=function(t){return Math.round(1e3*t)/1e3},command=function(t){return function(){for(var r=arguments.length,n=Array(r),e=0;e<r;e++)n[e]=arguments[e];return t+n.map(round).join(",")}},M=command("M"),l=command("l"),c=command("c"),pattern=function t(r){var n=r.width,e=r.height,o=r.bg,a=r.children,i=r.id||shortid(6);o&&(a=[dom("rect",{width:n+"",height:e+"",fill:o})].concat(a||[]));var t=dom("pattern",{id:i,width:n,height:e,patternUnits:"userSpaceOnUse"},a);return t.url=function(){return"url(#"+i+")"},t},pathPattern=function(t){var r=t,n=r.d,e=r.stroke,o=r.strokeWidth,a=r.children,i=dom("path",{d:n,stroke:e,"stroke-width":o+"","stroke-linecap":"square"});return t=Object.assign({},t,{children:[i].concat(a||[])}),pattern(t)};module.exports={round:round,M:M,l:l,c:c,pattern:pattern,pathPattern:pathPattern};

},{"shortid":15,"virtual-dom/h":27}],3:[function(require,module,exports){
"use strict";module.exports={lines:require("./p/lines"),circles:require("./p/circles"),squares:require("./p/squares"),nylon:require("./p/nylon"),waves:require("./p/waves"),woven:require("./p/woven"),crosses:require("./p/crosses"),caps:require("./p/caps"),hexagons:require("./p/hexagons"),rhombic3d:require("./p/rhombic3d"),rhombic:require("./p/rhombic")};

},{"./p/caps":42,"./p/circles":43,"./p/crosses":44,"./p/hexagons":45,"./p/lines":46,"./p/nylon":47,"./p/rhombic":48,"./p/rhombic3d":49,"./p/squares":50,"./p/waves":51,"./p/woven":52}],4:[function(require,module,exports){
...
},{"./lib/index":19}],16:[function(require,module,exports){
...
},{"./random/random-from-seed":22}],17:[function(require,module,exports){
"use strict";function decode(e){var r=alphabet.shuffled();return{version:15&r.indexOf(e.substr(0,1)),worker:15&r.indexOf(e.substr(1,1))}}var alphabet=require("./alphabet");module.exports=decode;

},{"./alphabet":16}],18:[function(require,module,exports){
"use strict";function encode(e,r){for(var o,n=0,t="";!o;)t+=e(r>>4*n&15|randomByte()),o=r<Math.pow(16,n+1),n++;return t}var randomByte=require("./random/random-byte");module.exports=encode;

},{"./random/random-byte":21}],19:[function(require,module,exports){
"use strict";function generate(){var e="",r=Math.floor(.001*(Date.now()-REDUCE_TIME));return r===previousSeconds?counter++:(counter=0,previousSeconds=r),e+=encode(alphabet.lookup,version),e+=encode(alphabet.lookup,clusterWorkerId),counter>0&&(e+=encode(alphabet.lookup,counter)),e+=encode(alphabet.lookup,r)}function seed(e){return alphabet.seed(e),module.exports}function worker(e){return clusterWorkerId=e,module.exports}function characters(e){return void 0!==e&&alphabet.characters(e),alphabet.shuffled()}var alphabet=require("./alphabet"),encode=require("./encode"),decode=require("./decode"),isValid=require("./is-valid"),REDUCE_TIME=1459707606518,version=6,clusterWorkerId=require("./util/cluster-worker-id")||0,counter,previousSeconds;module.exports=generate,module.exports.generate=generate,module.exports.seed=seed,module.exports.worker=worker,module.exports.characters=characters,module.exports.decode=decode,module.exports.isValid=isValid;

},{"./alphabet":16,"./decode":17,"./encode":18,"./is-valid":20,"./util/cluster-worker-id":23}],20:[function(require,module,exports){
"use strict";function isShortId(r){if(!r||"string"!=typeof r||r.length<6)return!1;for(var t=alphabet.characters(),e=r.length,a=0;a<e;a++)if(t.indexOf(r[a])===-1)return!1;return!0}var alphabet=require("./alphabet");module.exports=isShortId;

},{"./alphabet":16}],21:[function(require,module,exports){
"use strict";function randomByte(){if(!crypto||!crypto.getRandomValues)return 48&Math.floor(256*Math.random());var o=new Uint8Array(1);return crypto.getRandomValues(o),48&o[0]}var crypto="object"==typeof window&&(window.crypto||window.msCrypto);module.exports=randomByte;
...
},{"ev-store":4}],30:[function(require,module,exports){
...
},{"../vnode/is-thunk":33,"../vnode/is-vhook":34,"../vnode/is-vnode":35,"../vnode/is-vtext":36,"../vnode/is-widget":37,"../vnode/vnode.js":39,"../vnode/vtext.js":40,"./hooks/ev-hook.js":29,"./hooks/soft-set-hook.js":30,"./parse-tag.js":32,"x-is-array":41}],32:[function(require,module,exports){
...
},{"browser-split":28}],33:[function(require,module,exports){
...
"use strict";var dom=require("virtual-dom/h"),_require=require("../helpers"),M=_require.M,l=_require.l,pattern=_require.pattern,tile=function(e){return M(e/4,3*e/4)+l(e/4,-e/2)+l(e/4,e/2)},defaults={size:9,fill:"none",strokeWidth:.9,stroke:"#343434",background:null},caps=function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return e=Object.assign({},defaults,e),Object.assign(e,{width:e.size,height:e.size,bg:e.background,children:[dom("path",{d:tile(e.size),fill:e.fill,stroke:e.stroke,"stroke-width":e.strokeWidth+"","stroke-linecap":"square"})]}),pattern(e)};module.exports=caps;

},{"../helpers":2,"virtual-dom/h":27}],43:[function(require,module,exports){
"use strict";var _slicedToArray=function(){function r(r,e){var t=[],i=!0,n=!1,o=void 0;try{for(var l,s=r[Symbol.iterator]();!(i=(l=s.next()).done)&&(t.push(l.value),!e||t.length!==e);i=!0);}catch(r){n=!0,o=r}finally{try{!i&&s.return&&s.return()}finally{if(n)throw o}}return t}return function(e,t){if(Array.isArray(e))return e;if(Symbol.iterator in Object(e))return r(e,t);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),dom=require("virtual-dom/h"),_require=require("../helpers"),pattern=_require.pattern,defaults={size:15,radius:3,complement:!0,fill:"#545454",strokeWidth:0,stroke:"none",background:null},circles=function(){var r=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];r=Object.assign({},defaults,r);var e=r.size,t=[dom("circle",{cx:e/2,cy:e/2,r:r.radius,fill:r.fill,stroke:r.stroke,"stroke-width":r.strokeWidth+""})];if(r.complement===!0)for(var i=[[0,0],[0,e],[e,e],[e,0]],n=0;n<i.length;n++){var o=_slicedToArray(i[n],2),l=o[0],s=o[1];t.push(dom("circle",{cx:l,cy:s,r:r.radius,fill:r.fill,stroke:r.stroke,"stroke-width":r.strokeWidth+""}))}return Object.assign(r,{width:r.size,height:r.size,children:t,bg:r.background}),pattern(r)};module.exports=circles;

},{"../helpers":2,"virtual-dom/h":27}],44:[function(require,module,exports){
"use strict";var dom=require("virtual-dom/h"),_require=require("../helpers"),M=_require.M,l=_require.l,pattern=_require.pattern,tile=function(e){return M(e/4,e/4)+l(e/2,e/2)+M(e/4,3*e/4)+l(e/2,-e/2)},defaults={size:10,fill:"none",strokeWidth:.8,stroke:"#343434",background:null},crosses=function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return e=Object.assign({},defaults,e),Object.assign(e,{width:e.size,height:e.size,bg:e.background,children:[dom("path",{d:tile(e.size),fill:e.fill,stroke:e.stroke,"stroke-width":e.strokeWidth+"","stroke-linecap":"square"})]}),pattern(e)};module.exports=crosses;

},{"../helpers":2,"virtual-dom/h":27}],45:[function(require,module,exports){
"use strict";var dom=require("virtual-dom/h"),_require=require("../helpers"),M=_require.M,l=_require.l,round=_require.round,pattern=_require.pattern,tile=function(e){var t=e*Math.tan(Math.PI/6)*.5,r=.5*e/Math.cos(Math.PI/6);return M(0,e/2)+l(t,e/2)+l(r,0)+l(t,-e/2)+l(-t,-e/2)+l(-r,0)+l(-t,e/2)+"Z"+M(t+r+t,e/2)+l(r,0)},ratio=round(Math.tan(Math.PI/6)+1/Math.cos(Math.PI/6)),defaults={size:10,fill:"none",strokeWidth:1,stroke:"#343434",background:null},hexagons=function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return e=Object.assign({},defaults,e),Object.assign(e,{width:e.size*ratio,height:e.size,bg:e.background,children:[dom("path",{d:tile(e.size),fill:e.fill,stroke:e.stroke,"stroke-width":e.strokeWidth+"","stroke-linecap":"square"})]}),pattern(e)};module.exports=hexagons;

},{"../helpers":2,"virtual-dom/h":27}],46:[function(require,module,exports){
"use strict";var dom=require("virtual-dom/h"),_require=require("../helpers"),M=_require.M,l=_require.l,pattern=_require.pattern,tile=function(e,r){return e%180===0?M(r/2,0)+l(0,r):e%180===45?M(0,r)+l(r,-r)+M(-r/4,r/4)+l(r/2,-r/2)+M(3*r/4,5*r/4)+l(r/2,-r/2):e%180===-45?M(r,r)+l(-r,-r)+M(5*r/4,r/4)+l(-r/2,-r/2)+M(r/4,5*r/4)+l(-r/2,-r/2):e%180===90?M(0,r/2)+l(r,0):""},defaults={size:8,strokeWidth:.7,stroke:"#343434",background:null,orientations:[45]},lines=function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];e=Object.assign({},defaults,e);var r=e.orientations?Array.isArray(e.orientations)?e.orientations:[e.orientations]:[0,45];return Object.assign(e,{width:e.size,height:e.size,bg:e.background,children:r.map(function(r){return dom("path",{d:tile(r,e.size),stroke:e.stroke,"stroke-width":e.strokeWidth+"","stroke-linecap":"square"})})}),pattern(e)};module.exports=lines;

},{"../helpers":2,"virtual-dom/h":27}],47:[function(require,module,exports){
"use strict";var dom=require("virtual-dom/h"),_require=require("../helpers"),M=_require.M,l=_require.l,pattern=_require.pattern,tile=function(e){return M(0,e/4)+l(e/4,0)+l(0,-e/4)+M(3*e/4,e)+l(0,-e/4)+l(e/4,0)+M(e/4,e/2)+l(0,e/4)+l(e/4,0)+M(e/2,e/4)+l(e/4,0)+l(0,e/4)},defaults={size:15,fill:"none",strokeWidth:1,stroke:"#343434",background:null},nylon=function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return e=Object.assign({},defaults,e),Object.assign(e,{width:e.size,height:e.size,bg:e.background,children:[dom("path",{d:tile(e.size),fill:e.fill,stroke:e.stroke,"stroke-width":e.strokeWidth+"","stroke-linecap":"square"})]}),pattern(e)};module.exports=nylon;

},{"../helpers":2,"virtual-dom/h":27}],48:[function(require,module,exports){
"use strict";var dom=require("virtual-dom/h"),_require=require("../helpers"),M=_require.M,l=_require.l,pattern=_require.pattern,tile=function(e){return M(0,0)+l(e/2,e)+l(e/2,-e)+M(0,e)+l(e/2,-e)+l(e/2,e)},defaults={size:12,fill:"none",strokeWidth:.9,stroke:"#343434",background:null},rhombic=function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return e=Object.assign({},defaults,e),Object.assign(e,{width:e.size,height:e.size,bg:e.background,children:[dom("path",{d:tile(e.size),fill:e.fill,stroke:e.stroke,"stroke-width":e.strokeWidth+"","stroke-linecap":"square"})]}),pattern(e)};module.exports=rhombic;

},{"../helpers":2,"virtual-dom/h":27}],49:[function(require,module,exports){
"use strict";var dom=require("virtual-dom/h"),_require=require("../helpers"),M=_require.M,l=_require.l,pattern=_require.pattern,tile=function(e){var r=1.5*e/4,t=e/4;return""+M(1*r,0*t)+l(0,1*t)+M(3*r,0*t)+l(0,1*t)+M(0*r,1*t)+l(0,2*t)+M(2*r,1*t)+l(0,2*t)+M(4*r,1*t)+l(0,2*t)+M(1*r,3*t)+l(0,1*t)+M(3*r,3*t)+l(0,1*t)+M(0*r,1*t)+l(1*r,-1*t)+l(1*r,1*t)+l(1*r,-1*t)+l(1*r,1*t)+M(0*r,2*t)+l(1*r,-1*t)+l(1*r,1*t)+l(1*r,-1*t)+l(1*r,1*t)+M(0*r,2*t)+l(1*r,1*t)+l(1*r,-1*t)+l(1*r,1*t)+l(1*r,-1*t)+M(0*r,3*t)+l(1*r,1*t)+l(1*r,-1*t)+l(1*r,1*t)+l(1*r,-1*t)},ratio=1.5,defaults={size:14,fill:"none",strokeWidth:.6,stroke:"#343434",background:null},rhombic3d=function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return e=Object.assign({},defaults,e),Object.assign(e,{width:e.size*ratio,height:e.size,bg:e.background,children:[dom("path",{d:tile(e.size),fill:e.fill,stroke:e.stroke,"stroke-width":e.strokeWidth+"","stroke-linecap":"square"})]}),pattern(e)};module.exports=rhombic3d;

},{"../helpers":2,"virtual-dom/h":27}],50:[function(require,module,exports){
"use strict";var dom=require("virtual-dom/h"),_require=require("../helpers"),M=_require.M,l=_require.l,pattern=_require.pattern,tile=function(e){return M(e/4,e/4)+l(e/2,0)+l(0,e/2)+l(-e/2,0)+"z"},defaults={size:10,fill:"none",strokeWidth:.9,stroke:"#343434",background:null},squares=function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return e=Object.assign({},defaults,e),Object.assign(e,{width:e.size,height:e.size,bg:e.background,children:[dom("path",{d:tile(e.size),fill:e.fill,stroke:e.stroke,"stroke-width":e.strokeWidth+"","stroke-linecap":"square"})]}),pattern(e)};module.exports=squares;

},{"../helpers":2,"virtual-dom/h":27}],51:[function(require,module,exports){
"use strict";var dom=require("virtual-dom/h"),_require=require("../helpers"),M=_require.M,c=_require.c,pattern=_require.pattern,tile=function(e){return M(0,e/2)+c(e/8,-e/4,3*e/8,-e/4,e/2,0)+c(e/8,e/4,3*e/8,e/4,e/2,0)},defaults={size:8,fill:"none",strokeWidth:.8,stroke:"#343434",background:null},waves=function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return e=Object.assign({},defaults,e),Object.assign(e,{width:e.size,height:e.size,bg:e.background,children:[dom("path",{d:tile(e.size),fill:e.fill,stroke:e.stroke,"stroke-width":e.strokeWidth+"","stroke-linecap":"square"})]}),pattern(e)};module.exports=waves;

},{"../helpers":2,"virtual-dom/h":27}],52:[function(require,module,exports){
"use strict";var dom=require("virtual-dom/h"),_require=require("../helpers"),M=_require.M,l=_require.l,pattern=_require.pattern,tile=function(e){return M(e/4,e/4)+l(e/2,e/2)+M(3*e/4,e/4)+l(e/2,-e/2)+M(e/4,3*e/4)+l(-e/2,e/2)+M(3*e/4,5*e/4)+l(e/2,-e/2)+M(-e/4,e/4)+l(e/2,-e/2)},defaults={size:9,fill:"none",strokeWidth:1,stroke:"#343434",background:null},woven=function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return e=Object.assign({},defaults,e),Object.assign(e,{width:e.size,height:e.size,bg:e.background,children:[dom("path",{d:tile(e.size),fill:e.fill,stroke:e.stroke,"stroke-width":e.strokeWidth+"","stroke-linecap":"square"})]}),pattern(e)};module.exports=woven;

},{"../helpers":2,"virtual-dom/h":27}]},{},[1]);
