...
var patterns = require('./index.js');

var type = document.querySelector('#demo-type');
var opt = document.querySelector('#demo-options');
var defs = document.querySelector('#demo-target defs');
...
var render = function render() {
	...
	var o = Object.assign({}, defaults, JSON.parse(opt.value));

	var pattern = t.length === 1 ? patterns[t[0]](o) : patterns[t[0]](t[1], o);
	defs.innerHTML = toHTML(pattern);
};

type.addEventListener('change', render);
opt.addEventListener('change', render);
opt.addEventListener('keypress', function () {
	return setTimeout(render, 5);
});
setTimeout(render, 0);

},{"./index.js":3,"vdom-to-html":15}],2:[function(require,module,exports){
'use strict';
...
module.exports = { round: round, M: M, l: l, c: c, pattern: pattern, pathPattern: pathPattern };

},{"virtual-dom/h":18}],3:[function(require,module,exports){
'use strict';
...
},{"./p/caps":35,"./p/circles":36,"./p/crosses":37,"./p/hexagons":38,"./p/lines":39,"./p/nylon":40,"./p/rhombic":41,"./p/rhombic3d":42,"./p/squares":43,"./p/waves":44,"./p/woven":45}],4:[function(require,module,exports){
/*!
 * escape-html
...
},{"sentence-case":10}],10:[function(require,module,exports){
...
},{"./vendor/camel-case-regexp":11,"./vendor/non-word-regexp":12,"./vendor/trailing-digit-regexp":13,"lower-case":8}],11:[function(require,module,exports){
...
},{"./property-config":16,"escape-html":4}],15:[function(require,module,exports){
var escape = require('escape-html');
...
},{"./create-attribute":14,"./void-elements":17,"escape-html":4,"param-case":9,"virtual-dom/virtual-hyperscript/hooks/attribute-hook":20,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook":22,"virtual-dom/vnode/is-thunk":25,"virtual-dom/vnode/is-vnode":27,"virtual-dom/vnode/is-vtext":28,"virtual-dom/vnode/is-widget":29,"xtend":34}],16:[function(require,module,exports){
/**
 * Attribute types.
 */
...
},{"./virtual-hyperscript/index.js":23}],19:[function(require,module,exports){
/*!
...
},{"../vnode/is-thunk":25,"../vnode/is-vhook":26,"../vnode/is-vnode":27,"../vnode/is-vtext":28,"../vnode/is-widget":29,"../vnode/vnode.js":31,"../vnode/vtext.js":32,"./hooks/ev-hook.js":21,"./hooks/soft-set-hook.js":22,"./parse-tag.js":24,"x-is-array":33}],24:[function(require,module,exports){
'use strict';
...
},{"browser-split":19}],25:[function(require,module,exports){
...
},{"../helpers":2,"virtual-dom/h":18}],36:[function(require,module,exports){
'use strict';
...
},{"../helpers":2,"virtual-dom/h":18}],37:[function(require,module,exports){
'use strict';
...
},{"../helpers":2,"virtual-dom/h":18}],38:[function(require,module,exports){
'use strict';
...
var ratio = round(Math.tan(Math.PI / 6) + 1 / Math.cos(Math.PI / 6));
...
},{"../helpers":2,"virtual-dom/h":18}],39:[function(require,module,exports){
'use strict';
...
},{"../helpers":2,"virtual-dom/h":18}],40:[function(require,module,exports){
'use strict';
...
},{"../helpers":2,"virtual-dom/h":18}],41:[function(require,module,exports){
'use strict';
...
},{"../helpers":2,"virtual-dom/h":18}],42:[function(require,module,exports){
'use strict';
...
},{"../helpers":2,"virtual-dom/h":18}],43:[function(require,module,exports){
'use strict';
...
},{"../helpers":2,"virtual-dom/h":18}],44:[function(require,module,exports){
'use strict';
...
},{"../helpers":2,"virtual-dom/h":18}],45:[function(require,module,exports){
'use strict';
